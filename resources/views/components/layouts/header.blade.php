        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li>
                        <a href="{{ url('/') }}" class="block py-2 px-3 text-white rounded-sm">Home</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-white rounded-sm">Explore</a>
                    </li>
                    <li>
                        <a href="#" class="block py-2 px-3 text-white rounded-sm">About Us</a>
                    </li>
                    <li>
                        <a href="{{ url('register') }}" class="block py-2 px-3 text-white rounded-sm"><svg
