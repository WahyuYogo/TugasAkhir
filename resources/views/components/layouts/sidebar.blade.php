<x-layouts.app>
    ...
    <div class="justify-between flex items-center">
        ...
        <a href="/"
            class="inline-flex items-center p-2 mt-2 me-3 text-sm text-orange-500 rounded-lg sm:hidden hover:bg-orange-100 focus:outline-none focus:ring-2 focus:ring-orange-200 dark:text-orange-500 dark:hover:bg-orange-300 dark:focus:ring-orange-600">
        ...
        <div class="h-full px-8 py-6 overflow-y-auto bg-white border-r-2 border-gray-200">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ url('/profile') }}"
                        class="flex items-center p-2 text-black hover:text-orange-500 rounded-lg hover:bg-orange-100 group">
                        <svg class="w-5 h-5 text-black transition duration-75 group-hover:text-orange-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
