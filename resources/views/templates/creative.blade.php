...
<div class="w-full mx-auto text-center bg-white">
        <div class="relative">
            <div class="relative h-48 w-full bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]">
        ...
        <div class="mt-6  md:px-12 p-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mt-4">
                @foreach ($user->sociallinks as $link)
                    <a href="{{ $link->url }}" class="w-full flex items-center justify-center py-2 px-4 text-md font-medium text-gray-900 border hover:shadow-md border-gray-700 hover:border-gray-400 rounded-lg"><img src="https://www.google.com/s2/favicons?domain={{ parse_url($link->url, PHP_URL_HOST) }}&sz=32"
